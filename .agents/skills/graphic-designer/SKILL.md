...
[
  {
    ...
    "options": [
      ...
      {"label": "Whiteboard infographic", "description": "Hand-drawn marker style on a whiteboard or notebook page. Recaps the post visually."},
      {"label": "Branded infographic", "description": "Professional infographic using your brand colours. Recaps the post visually."},
...
Save the HTML file. If browser control is available, open and render it for visual QA before handing it off. Otherwise tell the user how to open the file locally.
...
- Image prompts (Path B) must be fully self-contained and provider-neutral.
