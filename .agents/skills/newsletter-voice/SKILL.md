...
description: >
  Build project-level newsletter writing instructions after voice-builder. Produces newsletter-voice.md from 2 to 3 past issues or one of 6 archetypes tuned to the user's voice. Use when the user says "build my newsletter voice", "learn my newsletter style", "set up my newsletter system", "train on my newsletters", or provides newsletter samples for analysis. Requires voice.md and about-me.md.
---
...
Ask the following question in chat, using an interactive input control only when the current Codex surface provides one:
